...
> **Downstream status:** this upstream v0.5.0 journey is reference-only in Paseo Foundation.
...
Upstream journey runs Hub on your machine, connects it to Slack without a public server, and answers a mention with an agent in your repository. Upstream browser setup hands off to your terminal, and its guided setup writes and deploys the workflow.
